		...
		<h2>Our Products</h2>			
		 <div class="col-md-9 product-model-sec">
					...
					<ul class="pagination justify-content-center">
						...
						<li class="page-item"><a class="page-link" href="<?php echo $_SERVER['REQUEST_URI'] . "&pagination=$i"?>"><?=$i?></a></li>
						<?php endfor; ?>
						<!--<li class="page-item">
			...
			<div class="rsidebar span_1_of_left">
				...
				<section class="sky-form">
				 ...
				 <section  class="sky-form">
				   ...
				   <?php $query = "SELECT round(p.net_price) as maxprice FROM prices p WHERE active = 1 ORDER BY p.net_price DESC LIMIT 1"; 
						 $result = $connection->query($query)->fetch();
				   ?>
				   <input type="hidden" id="pricemax" value="<?= $result->maxprice ?>"/>

				   <?php $query = "SELECT round(p.net_price) as minprice FROM prices p WHERE active = 1 ORDER BY p.net_price ASC LIMIT 1"; 
						 $result = $connection->query($query)->fetch();
				   ?>
